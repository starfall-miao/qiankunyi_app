...
import '../../../shared/constants/yao_plain_desc.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              if (yao.liuQin != LiuQin.none) ...[
                ...
                _refSection('六亲（核心关系）', [
                  _refRow('六亲', '${_liuQinCN[yao.liuQin]}',
                      liuQinDesc(yao.liuQin), textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
              ...
              if (yao.liuShen != null) ...[
                ...
                _refSection('六神（辅助信息）', [
                  _refRow('六神', '${_liuShenCN[yao.liuShen]}',
                      liuShenDesc(yao.liuShen!), textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
              ...
              if (yao.isShi || yao.isYing) ...[
                ...
                _refSection('世应（主客定位）', [
                  if (yao.isShi)
                    _refRow('世爻', '✅ 此爻为世爻', shiYaoDesc, textColor),
                  if (yao.isYing)
                    _refRow('应爻', '✅ 此爻为应爻', yingYaoDesc, textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
              ...
              if (yao.wangShuai != null) ...[
                ...
                _refSection('旺衰（力量强弱）', [
                  _refRow('旺衰', '${_wangShuaiCN[yao.wangShuai]}',
                      wangShuaiDesc(yao.wangShuai!), textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
              ...
              if (yao.isKongWang) ...[
                const SizedBox(height: 12),
                _refSection('旬空（空亡）', [
                  _refRow('旬空', '✅ 此爻逢空', kongWangDesc, textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
              ...
              if (yao.isXing || yao.isChong || yao.isHe || yao.isHai || yao.sanHeJu.isNotEmpty) ...[
                ...
                _refSection('刑冲合害（特殊关系）', [
                  if (yao.isXing) _refRow('刑', '✅ 相刑', xingDesc, textColor),
                  if (yao.isChong) _refRow('冲', '✅ 相冲', chongDesc, textColor),
                  if (yao.isHe) _refRow('合', '✅ 相合', heDesc, textColor),
                  if (yao.isHai) _refRow('害', '✅ 相害', haiDesc, textColor),
                  if (yao.sanHeJu.isNotEmpty)
                    _refRow('三合', yao.sanHeJu.join('、'), sanHeDesc, textColor),
                ], cardColor, textColor, theme.colorScheme.primary),
              ],
