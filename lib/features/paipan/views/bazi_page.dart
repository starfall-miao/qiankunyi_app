...
class _BaziPageState extends State<BaziPage> {
  ...
  /// 截图排盘结果并保存/分享
  Future<void> _saveImage(GlobalKey key, BuildContext context) async {
    try {
      final boundary =
      ...
      final file = File(
        '${tempDir.path}/qiankunyi_paipan_${DateTime.now().millisecondsSinceEpoch}.png',
      );
