...
class NaYin {
  ...
  final String wuXing;
  final String description;
  const NaYin(this.naYin, this.wuXing, [this.description = '']);
}

/// 六十甲子纳音表，按甲子~癸亥顺序排列
const naYinTable = <NaYin>[
  NaYin('海中金','金', '海底宝藏，隐而不露，需待时机发掘。命主多内秀，家底深厚。'),
  NaYin('炉中火','火', '炉火炼金，持续稳定。命主勤恳踏实，中年后渐入佳境。'),
  NaYin('大林木','木', '森林茂盛，生机勃勃。命主根基深厚，贵人众多。'),
  NaYin('路旁土','土', '路边之土，滋养行人。命主乐善好施，平凡中见真章。'),
  NaYin('剑锋金','金', '宝剑锋芒，锐不可当。命主果断刚毅，利事业开拓。'),
  NaYin('山头火','火', '山巅野火，势不可挡。命主热情奔放，但需防急躁。'),
  NaYin('涧下水','水', '山涧清泉，清澈见底。命主聪慧明理，心性澄澈。'),
  NaYin('城头土','土', '城墙之土，护卫一方。命主持重可靠，适合管理之职。'),
  NaYin('白蜡金','金', '白蜡镀金，外表华美。命主善于交际，重外表修饰。'),
  NaYin('杨柳木','木', '杨柳依依，柔美多姿。命主多才多艺，善变通适应。'),
  NaYin('泉中水','水', '泉水暗涌，源源不绝。命主内敛深沉，有持久力。'),
  NaYin('屋上土','土', '屋顶覆土，遮蔽风雨。命主居家安稳，重家庭亲情。'),
  NaYin('霹雳火','火', '雷火交加，瞬间爆发。命主性情刚烈，机遇来得快去得也快。'),
  NaYin('松柏木','木', '松柏长青，坚韧不拔。命主意志坚定，逆境中见品格。'),
  NaYin('长流水','水', '长河奔流，绵延不绝。命主运势悠长，福泽深厚。'),
  NaYin('砂石金','金', '砂中淘金，历尽艰辛。命主先苦后甜，经过磨练方显价值。'),
  NaYin('山下火','火', '山下篝火，温暖人间。命主和善可亲，晚年安泰。'),
  NaYin('平地木','木', '平川之木，舒展从容。命主坦途顺畅，一生平稳。'),
  NaYin('壁上土','土', '墙上之土，装饰点缀。命主善于辅助他人，宜做幕僚。'),
  NaYin('金箔金','金', '金箔薄片，华而不实。命主外表光鲜，需防虚浮不实。'),
  NaYin('覆灯火','火', '油灯之火，持续不灭。命主学业有成，文运昌盛。'),
  NaYin('天河水','水', '银河之水，高远浩瀚。命主胸怀宽广，志向远大。'),
  NaYin('大驿土','土', '驿站之土，迎来送往。命主交友广阔，奔波劳碌中得机遇。'),
  NaYin('钗钏金','金', '金银首饰，闺中之物。命主内秀外慧，宜文职艺术。'),
  NaYin('桑柘木','木', '桑柘之木，春蚕食叶。命主勤劳致富，衣食无忧。'),
  NaYin('大溪水','水', '溪流奔涌，顺势而行。命主思维敏捷，善于把握时机。'),
  NaYin('沙中土','土', '沙中之土，含金待炼。命主潜力深厚，需遇良机方显。'),
  NaYin('天上火','火', '太阳之火，光明普照。命主贵气十足，声名远扬。'),
  NaYin('石榴木','木', '石榴结实，多子多福。命主人缘好，子女昌盛。'),
  NaYin('大海水','水', '大海之水，包容万物。命主心胸开阔，福寿绵长。'),
];
